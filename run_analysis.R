...
download.file(fileUrl, destfile="C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset.zip")
unzip(zipfile="C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset.zip",exdir="C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset")
```

#### 2 - List data
```{r}
path_rf <- file.path("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/" , "UCI HAR Dataset")
...
```{r}
X_test<-read.table("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/UCI HAR Dataset/test/X_test.txt", header=FALSE)
X_train<- read.table("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/UCI HAR Dataset/train/X_train.txt", header=FALSE)

y_test<-read.table("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/UCI HAR Dataset/test/y_test.txt", header=FALSE)
y_train<-read.table("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/UCI HAR Dataset/train/y_train.txt", header=FALSE)

subject_test<-read.table("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/UCI HAR Dataset/test/subject_test.txt", header=FALSE)
subject_train<-read.table("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/UCI HAR Dataset/train/subject_train.txt", header=FALSE)

features<-readLines("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/UCI HAR Dataset/features.txt")
activity_labels<-read.table("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/GetDataA1Dataset/UCI HAR Dataset/activity_labels.txt", header=FALSE)
...
write.table(agg.CombinedFitData, file = "C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/tidydata.txt",row.name=FALSE)
```

5 - Codebook.
```{r}
library(knitr); knit2html("C:/Users/Huitzilopoctli/Desktop/GettingCleaningDataA1/codebook.Rmd");
```
